  ...
  return (
    ...
    mt-10">
      ...
      border-white/30">
        ...
        w-full">
          <img src={assets.logo1} alt="logo1"  className="w-32 h-auto"/>
          <p className="mt-6 text-center md:text-left text-sm text-white/80">We run this things for you ao thank you for your support</p>
        </div>
      ...
      <p className="py-6 text-center text-sm text-white/80 border-t border-white/10"> © 2025 WatexyTech — All Rights Reserved.</p>

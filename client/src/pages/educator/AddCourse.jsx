...
const AddCourse = () => {
  ...
  const addLecture = () => {
    if (isAddingLecture) return; // prevent double click
    ...
    setIsAddingLecture(false); // re-enable button
  };
          ...
          {showPopup && (
            <div className="fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-50">
              <div className="bg-white text-gray-700 p-4 rounded relative w-full max-w-80">
                ...
                <button
                  type="button"
                  className="w-full bg-blue-400 text-white px-4 py-2 rounded disabled:opacity-60 flex items-center justify-center gap-2"
                  onClick={addLecture}

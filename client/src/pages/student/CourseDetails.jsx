    ...
    pt-20 text-left">
      ...
      items-start justify-between text-left">
          ...
          <div className="w-full md:w-2/3 space-y-5">
            <h1 className="text-4xl font-bold text-gray-800 leading-tight">{courseData.courseTitle}</h1>
            ...
            <div className="pt-8 text-gray-800">
              ...
              <div className="pt-5">
                {courseData.courseContent.map((chapter, index) => (
                  <div key={index} className="border border-gray-3000 bg-white mb-2
                  rounded">
          ...
          <div className="max-w-[424px] shadow-[0px_4px_15px_2px_rgba(0,0,0,0.1)]
           rounded-t md:rounded-none overflow-hidden bg-white 
